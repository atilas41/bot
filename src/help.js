const help = (prefix) => {
	return `💎 Comandos do AcreBot 💎  
🔰 Principais Comandos 🔰 

Comando: '${prefix}botvip'
Função: Mostra como você pode ter o AcreBot versão exclusiva para seu grupo ou individual😉
...
Whatsapp: https://wa.me/message/JHCCODANQZHWP1
...
Comando: '${prefix}pack'
Função: Enviar um pacote de links +18 *(em atualiza��es)*
